...
Files: macbook-16.glb [639.28KB] > /Users/ct/Desktop/WebDev/macbook-landing/public/models/macbook-16-transformed.glb [629.72KB] (1%)
    ...
    scene.traverse((child) => {
      if (child.isMesh) {
        if (!noChangeParts.includes(child.name)) {
          ...
          // or child.material.color = new Color(color);
        }
      }
    });
  }, [color, scene]);
